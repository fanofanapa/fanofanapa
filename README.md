...
flowchart BT
    c_lang["<div style='text-align: left; padding: 0px;'><b>C Language</b><br/>Образовательные проекты<br/>• <a href='https://github.com/fanofanapa/matrix_lib_c_edu'>Библиотека для работы с матрицами</a><br/>• <a href='https://github.com/fanofanapa/decimal_lib_c_edu'>Структура данных decimal для Си</a><br/>• <a href='https://github.com/fanofanapa/strings_lib_c_edu'>Своя библиотека string.h</a><br/>• <a href='https://github.com/fanofanapa/cat_grep_educational/tree/main'>Системные утилиты cat grep</a></div>"]
